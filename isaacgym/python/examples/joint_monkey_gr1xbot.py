...
asset_descriptors = [
    AssetDesc("urdf/MOS/urdf/thmos_onlylegs.urdf", True),
    #AssetDesc("urdf/GR1T1/urdf/GR1T1.urdf", True),
    #AssetDesc("urdf/XBot/urdf/XBot-L.urdf", True)
]
...
asset_options.flip_visual_attachments = False#asset_descriptors[args.asset_id].flip_visual_attachments
...
stiffnesses = dof_props['stiffness']#[251.625, 453.15, 285.8131,285.8131,21.961,2.0761, 
               #251.625, 453.15, 285.8131,285.8131,21.961,2.0761]
dampings = dof_props['damping']#[14.72, 50.4164, 16.5792,16.5792,1.195, 0.1233,
            #14.72, 50.4164, 16.5792,16.5792,1.195, 0.1233]
...
for i in range(num_envs):
    ...
    pose.p = gymapi.Vec3(0.0, 2.00, 0.0)
